 ...
 */
public abstract class AsciiFeatureCodec<T extends org.igv.tribble.Feature> extends AbstractFeatureCodec<T, LineIterator> {
     ...
     * {@link LineIterator#next()} in implementing classes and, instead, have them implement
    ...
    /**
     * @see AsciiFeatureCodec#decode(LineIterator)
     */
