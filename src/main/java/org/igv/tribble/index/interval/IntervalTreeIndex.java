...
import org.igv.tribble.index.AbstractIndex;
 ...
 * @author jrobinso
 * @date Jul 9, 2010
 * @see org.igv.tribble.index.interval.IntervalTree
 */
public class IntervalTreeIndex extends AbstractIndex {
     ...
     * @param interval
     */
    public void insert(final String chr, final org.igv.tribble.index.interval.Interval interval) {
    ...
    public static class ChrIndex implements org.igv.tribble.index.ChrIndex {

        org.igv.tribble.index.interval.IntervalTree tree;
        String name;
        ...
        public ChrIndex(final String name) {
            this.name = name;
            tree = new org.igv.tribble.index.interval.IntervalTree();
        }
        ...
        public void insert(final org.igv.tribble.index.interval.Interval iv) {
            tree.insert(iv);
        }
        ...
        public List<Block> getBlocks(final int start, final int end) {
            ...
            final List<org.igv.tribble.index.interval.Interval> intervals = tree.findOverlapping(new org.igv.tribble.index.interval.Interval(start, end));
            ...
            int idx = 0;
            for (final org.igv.tribble.index.interval.Interval iv : intervals) {
        ...
        public void write(final LittleEndianOutputStream dos) throws IOException {
            ...
            final List<org.igv.tribble.index.interval.Interval> intervals = tree.getIntervals();

            dos.writeInt(intervals.size());
            for (final org.igv.tribble.index.interval.Interval interval : intervals) {
        ...
        public void read(final LittleEndianInputStream dis) throws IOException {
            ...
            while (nIntervals-- > 0) {
                ...
                final org.igv.tribble.index.interval.Interval iv = new Interval(start, end, new Block(pos, size));
                tree.insert(iv);
            }
