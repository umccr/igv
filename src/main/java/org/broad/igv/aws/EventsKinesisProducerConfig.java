...
public class EventsKinesisProducerConfig {
     ...
     */
    public EventsKinesisProducerConfig(String[] args) {
        int argIndex = 0;
        ...
        Set<ConstraintViolation<EventsKinesisProducerConfig>> violations = validator.validate(this);

        for (ConstraintViolation<EventsKinesisProducerConfig> violation : violations) {
