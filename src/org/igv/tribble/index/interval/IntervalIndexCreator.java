...
import org.igv.tribble.index.interval.IntervalTreeIndex.ChrIndex;
...
public class IntervalIndexCreator extends TribbleIndexCreator {
    ...
    public Index finalizeIndex(final long finalFilePosition) {
        final org.igv.tribble.index.interval.IntervalTreeIndex featureIndex = new org.igv.tribble.index.interval.IntervalTreeIndex(inputFile.getAbsolutePath());
...
class MutableInterval {
    ...
    public org.igv.tribble.index.interval.Interval toInterval() {
