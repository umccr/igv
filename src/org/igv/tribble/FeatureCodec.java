 ...
 * {@link #decode(SOURCE)} - Reads a {@link org.igv.tribble.Feature} record, provided a {@link SOURCE} pointing at the beginning of a record within the
 * source input.
 * <p/>
 ...
 *
 * @param <FEATURE_TYPE> The type of {@link org.igv.tribble.Feature} this codec generates
 * @param <SOURCE>       The type of the data source this codec reads from
 */
public interface FeatureCodec<FEATURE_TYPE extends org.igv.tribble.Feature, SOURCE> {
    /**
     ...
     * a comment)
     */
    public org.igv.tribble.Feature decodeLoc(final SOURCE source) throws IOException;

    /**
     * Decode a single {@link org.igv.tribble.Feature} from the {@link SOURCE}, reading no further in the underlying source than beyond that feature.
     *
     * @param source the input stream from which to decode the next record
     ...
     * more. Otherwise, data that might otherwise be fed into parsing a {@link org.igv.tribble.Feature} may be lost.
     *
    ...
    /**
     * Generates a {@link LocationAware} reader of type {@link SOURCE}.  Like {@link #makeSourceFromStream(InputStream)}, except
