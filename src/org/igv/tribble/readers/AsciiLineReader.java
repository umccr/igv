 ...
 * <p>
 * {@link BufferedReader} and its {@link BufferedReader#readLine()} method should be used in preference to this class (when the
 * {@link LocationAware} functionality is not required) because it offers greater performance.
 *
 * @author jrobinso
 */
public class AsciiLineReader implements org.igv.tribble.readers.LineReader, LocationAware {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            final org.igv.tribble.readers.LineReader reader = new AsciiLineReader(pbs);
            t0 = System.currentTimeMillis();
            lineCount = 0;
